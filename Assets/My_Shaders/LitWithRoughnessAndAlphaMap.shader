Shader "HDRP/LitWithRoughnessAndAlphaMap"
{
    Properties
    {
    ...
    // #include "Assets/My_Shaders/LitCustomizable_Include.hlsl"
    ...
    // Defines getting roughness from a map
    #define _ROUGHNESS_FROM_MAP
    // Defines getting alpha a map
    #define _ALPHA_FROM_MAP
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "LitDataExt_RoughnessAndAlphaMap.hlsl"
