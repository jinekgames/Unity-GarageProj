...
#if defined(_ROUGHNESS_FROM_MAP)
#define SAMPLER_ROUGHNESSMAP_IDX sampler_RoughnessMap
#endif  // defined(_ROUGHNESS_FROM_MAP)

#if defined(_ALPHA_FROM_MAP)
#define SAMPLER_ALPHAMAP_IDX sampler_AlphaMap
#endif  // defined(_ALPHA_FROM_MAP)
...
#endif
#include "LitDataIndividualLayerExt.hlsl"
...
#if defined(SAMPLER_ALPHAMAP_IDX) && !defined(SHADER_STAGE_RAY_TRACING)
    float alphaTex = SAMPLE_UVMAPPING_TEXTURE2D(_AlphaMap, sampler_AlphaMap, layerTexCoord.base).r;
    float alphaCutoff = 0.5;
    // GENERIC_ALPHA_TEST(alphaTex, alphaCutoff);
    clip(alphaTex - alphaCutoff);
#else  // !(defined(SAMPLER_ALPHAMAP_IDX) && !defined(SHADER_STAGE_RAY_TRACING))
...
#endif  // defined(SAMPLER_ALPHAMAP_IDX) && !defined(SHADER_STAGE_RAY_TRACING)
